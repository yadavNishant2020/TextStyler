...
"form-control me-2" type="search" placeholder="Search" aria-label="Search"/>
  ...
  <input className="form-check-input" type="checkbox" onClick={props.toggleModeBlue} id="flexSwitchCheckDefault" />
  <label className="form-check-label" htmlFor="flexSwitchCheckDefault">Enable Blue Dark Mode</label>
</div>
          <div className={`form-check form-switch text-${props.mode==='light'?'dark':'light'}`}>
  <input className="form-check-input" type="checkbox" onClick={props.toggleModeGreen} id="flexSwitchCheckDefault" />
